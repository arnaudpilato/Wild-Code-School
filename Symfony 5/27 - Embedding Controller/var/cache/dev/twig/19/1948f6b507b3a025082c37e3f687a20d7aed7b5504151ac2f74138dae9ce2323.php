...
class __TwigTemplate_89e385a8be071df02f9264324ebe4607cb9c5c67b64adc45364661d5b5931b7e extends Template
{
    private $source;
    private $macros = [];
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["program"]) {
            // line 7
            echo "            <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_show", ["slug" => twig_get_attribute($this->env, $this->source, $context["program"], "slug", [], "any", false, false, false, 7)]), "html", null, true);
            echo "\"><li>";
...
";
    ...
    {
        return array (  89 => 9,  78 => 7,  74 => 6,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    ...
    <ul>
        {% for program in programs %}
            <a href=\"{{ path('program_show', {slug: program.slug}) }}\"><li>{{ program.title }}</li></a>
        {% endfor %}
    </ul>
{% endblock %}", "actor/show.html.twig", "/Users/pil/PhpstormProjects/wild-series/templates/actor/show.html.twig");
    }
}
