...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 8
        echo "    <h1>Liste des séries :</h1><br>
    ";
        // line 9
        ...
        <a href=\"";
            // line 14
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_show", ["id" => twig_get_attribute($this->env, $this->source, $context["program"], "id", [], "any", false, false, false, 14)]), "html", null, true);
...
";
    ...
    {
        return array (  149 => 18,  142 => 16,  127 => 14,  122 => 12,  114 => 11,  111 => 10,  93 => 9,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <h1>Liste des séries :</h1><br>
    {% for program in programs %}
        <div>
            <h2>{{ loop.index }} / {{ program.title }} - Catégorie : {{ program.category.name }}</h2>
            <p>{{ program.summary }}</p>
        </div>
        <a href=\"{{ path(\"program_show\", { id: program.id }) }}\">Voir la fiche</a><br>
    {% else %}
        Aucune série trouvée.
    {% endfor %}
    <a href=\"{{ path('app_index') }}\">Retour à l'accueil</a>
{% endblock %}", "program/index.html.twig", "/Users/pil/PhpstormProjects/wild-series/templates/program/index.html.twig");
    }
}
