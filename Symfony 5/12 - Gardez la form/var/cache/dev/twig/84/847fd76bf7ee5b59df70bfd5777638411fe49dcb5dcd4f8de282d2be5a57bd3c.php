...
class __TwigTemplate_dd75fdb019b69458a967356a7e8197bc11ee4f4bad6ca955c28f3b8d920a54da extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <a href=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_season_show", ["program" => twig_get_attribute($this->env, $this->source, (isset($context["program"]) || array_key_exists("program", $context) ? $context["program"] : (function () { throw new RuntimeError('Variable "program" does not exist.', 8, $this->source); })()), "id", [], "any", false, false, false, 8), "season" => twig_get_attribute($this->env, $this->source, (isset($context["season"]) || array_key_exists("season", $context) ? $context["season"] : (function () { throw new RuntimeError('Variable "season" does not exist.', 8, $this->source); })()), "id", [], "any", false, false, false, 8)]), "html", null, true);
...
{% block body %}
    <div>
        ...
        <a href=\"{{ path('program_season_show', {program: program.id, season: season.id}) }}\">Retour sur la saison {{ season.id }}</a>
    </div>
