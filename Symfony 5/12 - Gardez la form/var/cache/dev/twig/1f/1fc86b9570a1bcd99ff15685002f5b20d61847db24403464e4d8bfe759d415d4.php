...
class __TwigTemplate_91a800acd375fa50a8cd7f5d71e95d88b54e10565da8f937168e10ef26fc39c9 extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["seasons"]) || array_key_exists("seasons", $context) ? $context["seasons"] : (function () { throw new RuntimeError('Variable "seasons" does not exist.', 13, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["season"]) {
            // line 14
            echo "                    <li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_season_show", ["program" => twig_get_attribute($this->env, $this->source, (isset($context["program"]) || array_key_exists("program", $context) ? $context["program"] : (function () { throw new RuntimeError('Variable "program" does not exist.', 14, $this->source); })()), "id", [], "any", false, false, false, 14), "season" => twig_get_attribute($this->env, $this->source, $context["season"], "id", [], "any", false, false, false, 14)]), "html", null, true);
            echo "\">Saison ";
...
";
    ...
    {
        return array (  131 => 17,  128 => 16,  117 => 14,  113 => 13,  108 => 11,  104 => 10,  100 => 9,  93 => 7,  90 => 6,  80 => 5,  59 => 3,  36 => 1,);
    }
        ...
        <div class=\"media-body\">
            ...
            <ul>
                {% for season in seasons %}
                    <li><a href=\"{{ path('program_season_show', {program: program.id, season: season.id}) }}\">Saison {{ season.number }}</a></li>
                {% endfor %}
            </ul>
