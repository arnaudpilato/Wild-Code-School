...
class __TwigTemplate_a55e15a12a94dab9d3a74acaf26d086d295a5bdc882dab41d8358e7b18ca0a8e extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    <section style=\"background-color: #264653; border-radius: 8px\" class=\"email\">
        ...
        <p><a style=\"color:#F4A261; border-radius: 8px; background: #264653; text-decoration: none;\" href=\"http://127.0.0.1:8000/programs/{{episode.season.program.slug}}/seasons/{{ episode.season.id }}/episodes/{{ episode.slug }}\">Voir l'épisode</a></p>
    </section>
