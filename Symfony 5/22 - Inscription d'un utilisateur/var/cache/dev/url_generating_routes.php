...
return [
    ...
    'actor_show' => [['id'], ['_controller' => 'App\\Controller\\ActorController::show'], ['id' => '\\d+'], [['variable', '/', '\\d+', 'id', true], ['text', '/actor']], [], []],
    ...
    'profile_index' => [[], ['_controller' => 'App\\Controller\\ProfileController::index'], [], [['text', '/my-profile/']], [], []],
    ...
    'program_season_show' => [['slug', 'season'], ['_controller' => 'App\\Controller\\ProgramController::showSeason'], [], [['variable', '/', '[^/]++', 'season', true], ['text', '/season'], ['variable', '/', '[^/]++', 'slug', true], ['text', '/programs']], [], []],
    'program_episode_show' => [['program_slug', 'season', 'episode_slug'], ['_controller' => 'App\\Controller\\ProgramController::showEpisode'], [], [['variable', '/', '[^/]++', 'episode_slug', true], ['text', '/episodes'], ['variable', '/', '[^/]++', 'season', true], ['text', '/seasons'], ['variable', '/', '[^/]++', 'program_slug', true], ['text', '/programs']], [], []],
    'program_edit' => [['slug'], ['_controller' => 'App\\Controller\\ProgramController::edit'], [], [['text', '/edit'], ['variable', '', '[^/]++', 'slug', true], ['text', '/programs']], [], []],
    'program_delete_comment' => [['id'], ['_controller' => 'App\\Controller\\ProgramController::deleteComment'], [], [['text', '/delete'], ['variable', '/', '[^/]++', 'id', true], ['text', '/programs/comment']], [], []],
    ...
    'app_verify_email' => [[], ['_controller' => 'App\\Controller\\SecurityController::verifyUserEmail'], [], [['text', '/verify/email']], [], []],
