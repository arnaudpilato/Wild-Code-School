...
class __TwigTemplate_89e385a8be071df02f9264324ebe4607cb9c5c67b64adc45364661d5b5931b7e extends Template
{
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["program"]) {
            // line 7
            echo "            <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_show", ["id" => twig_get_attribute($this->env, $this->source, $context["program"], "id", [], "any", false, false, false, 7)]), "html", null, true);
            echo "\"><li>";
...
{% block body %}
    ...
    <ul>
        {% for program in programs %}
            <a href=\"{{ path('program_show', {id: program.id}) }}\"><li>{{ program.title }}</li></a>
        {% endfor %}
    </ul>
