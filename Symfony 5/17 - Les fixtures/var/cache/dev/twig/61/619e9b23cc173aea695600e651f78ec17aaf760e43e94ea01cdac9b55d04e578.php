...
{% block body %}
    ...
    <ul>
        {% for episode in episodes %}
            <li><a href=\"{{ path(\"program_episode_show\", { program: program.id, season: season.id, episode: episode.id }) }}\">{{ episode.title }}</a></li>
        {% endfor %}
    </ul>
