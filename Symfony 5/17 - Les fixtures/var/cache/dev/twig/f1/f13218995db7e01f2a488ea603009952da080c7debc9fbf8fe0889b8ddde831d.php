...
";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["program"]) {
            ...
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_show", ["id" => twig_get_attribute($this->env, $this->source, $context["program"], "id", [], "any", false, false, false, 22)]), "html", null, true);
...
";
    ...
    {
        return array (  144 => 30,  141 => 29,  134 => 27,  124 => 22,  119 => 20,  115 => 19,  111 => 18,  105 => 15,  101 => 13,  96 => 12,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
    ...
    {% for program in programs %}
        <div class=\"movie col-5 d-flex\">
            ...
            <div class=\"col-6\">
                ...
                <p>{{ program.summary }}</p>
                <div class=\"button\">
                    <a class=\"btn btn-secondary\" href=\"{{ path(\"program_show\", { id: program.id }) }}\">Voir la fiche</a>
                </div>
            </div>
        </div>
    {% else %}
