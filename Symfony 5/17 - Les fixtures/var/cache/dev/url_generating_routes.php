...
return [
    ...
    'program_show' => [['id'], ['_controller' => 'App\\Controller\\ProgramController::show'], ['id' => '\\d+'], [['variable', '/', '\\d+', 'id', true], ['text', '/programs/show']], [], []],
    'program_season_show' => [['program', 'season'], ['_controller' => 'App\\Controller\\ProgramController::showSeason'], ['program' => '\\d+', 'season' => '\\d+'], [['variable', '/', '\\d+', 'season', true], ['text', '/season'], ['variable', '/', '\\d+', 'program', true], ['text', '/programs']], [], []],
    'program_episode_show' => [['program', 'season', 'episode'], ['_controller' => 'App\\Controller\\ProgramController::showEpisode'], [], [['variable', '/', '[^/]++', 'episode', true], ['text', '/episodes'], ['variable', '/', '[^/]++', 'season', true], ['text', '/seasons'], ['variable', '/', '[^/]++', 'program', true], ['text', '/programs']], [], []],
