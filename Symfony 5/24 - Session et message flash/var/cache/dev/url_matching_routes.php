...
return [
    ...
    [ // $staticRoutes
        ...
        '/my-profile' => [[['_route' => 'profile_index', '_controller' => 'App\\Controller\\ProfileController::index'], null, ['GET' => 0], null, true, false, null]],
        ...
        '/verify/email' => [[['_route' => 'app_verify_email', '_controller' => 'App\\Controller\\SecurityController::verifyUserEmail'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        296 => [[['_route' => 'program_show', '_controller' => 'App\\Controller\\ProgramController::show'], ['slug'], ['GET' => 0], null, false, true, null]],
        331 => [[['_route' => 'program_season_show', '_controller' => 'App\\Controller\\ProgramController::showSeason'], ['slug', 'season'], ['GET' => 0], null, false, true, null]],
        367 => [[['_route' => 'program_episode_show', '_controller' => 'App\\Controller\\ProgramController::showEpisode'], ['program_slug', 'season', 'episode_slug'], null, null, false, true, null]],
        390 => [[['_route' => 'program_edit', '_controller' => 'App\\Controller\\ProgramController::edit'], ['slug'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        425 => [[['_route' => 'program_delete_comment', '_controller' => 'App\\Controller\\ProgramController::deleteComment'], ['id'], ['DELETE' => 0], null, false, false, null]],
        451 => [[['_route' => 'program_watchlist', '_controller' => 'App\\Controller\\ProgramController::addToWatchlist'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        480 => [[['_route' => 'season_show', '_controller' => 'App\\Controller\\SeasonController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        493 => [[['_route' => 'season_edit', '_controller' => 'App\\Controller\\SeasonController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        501 => [
