...
class __TwigTemplate_91a800acd375fa50a8cd7f5d71e95d88b54e10565da8f937168e10ef26fc39c9 extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["season"]) {
            // line 14
            echo "                    <li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_season_show", ["programId" => twig_get_attribute($this->env, $this->source, (isset($context["program"]) || array_key_exists("program", $context) ? $context["program"] : (function () { throw new RuntimeError('Variable "program" does not exist.', 14, $this->source); })()), "id", [], "any", false, false, false, 14), "seasonId" => twig_get_attribute($this->env, $this->source, $context["season"], "id", [], "any", false, false, false, 14)]), "html", null, true);
            echo "\">Saison ";
        ...
        <div class=\"media-body\">
            ...
            <ul>
                {% for season in seasons %}
                    <li><a href=\"{{ path('program_season_show', {programId: program.id, seasonId: season.id}) }}\">Saison {{ season.number }}</a></li>
                {% endfor %}
            </ul>
