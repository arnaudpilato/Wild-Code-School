...
return [
    ...
    'program_season_show' => [['programId', 'seasonId'], ['_controller' => 'App\\Controller\\ProgramController::showSeason'], [], [['variable', '/', '[^/]++', 'seasonId', true], ['text', '/season'], ['variable', '/', '[^/]++', 'programId', true], ['text', '/programs']], [], []],
];
