...
class __TwigTemplate_0ae82c79d70da5aed43351843dff757f32c2143e4b920b967380bdc4ef37a250 extends Template
{
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["episode"]) {
            // line 9
            echo "            <li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_episode_show", ["program_slug" => twig_get_attribute($this->env, $this->source, (isset($context["program"]) || array_key_exists("program", $context) ? $context["program"] : (function () { throw new RuntimeError('Variable "program" does not exist.', 9, $this->source); })()), "slug", [], "any", false, false, false, 9), "season" => twig_get_attribute($this->env, $this->source, (isset($context["season"]) || array_key_exists("season", $context) ? $context["season"] : (function () { throw new RuntimeError('Variable "season" does not exist.', 9, $this->source); })()), "id", [], "any", false, false, false, 9), "episode_slug" => twig_get_attribute($this->env, $this->source, $context["episode"], "slug", [], "any", false, false, false, 9)]), "html", null, true);
            echo "\">";
    ...
    <a href=\"";
        // line 12
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_show", ["slug" => twig_get_attribute($this->env, $this->source, (isset($context["program"]) || array_key_exists("program", $context) ? $context["program"] : (function () { throw new RuntimeError('Variable "program" does not exist.', 12, $this->source); })()), "slug", [], "any", false, false, false, 12)]), "html", null, true);
...
";
    ...
    {
        return array (  99 => 12,  96 => 11,  85 => 9,  81 => 8,  75 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
