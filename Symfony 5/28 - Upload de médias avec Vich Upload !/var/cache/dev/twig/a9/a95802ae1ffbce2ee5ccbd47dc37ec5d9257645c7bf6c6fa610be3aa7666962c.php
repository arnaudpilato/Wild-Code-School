...
class __TwigTemplate_88c14aad29f8204245fda8c942a7bfa0fd524b4f166f46a3aa42fd87f7300316 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    <h1>";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("add.program"), "html", null, true);
        echo "</h1>
    ";
        // line 5
...
";
    ...
    {
        return array (  82 => 8,  77 => 6,  73 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    <h1>{{ 'add.program'|trans }}</h1>
    {{ form_start(form, {'attr': {'novalidate': 'novalidate'}}) }}
    {{ form_widget(form) }}
    <input type=\"submit\" value=\"Add Program\">
    {{ form_end(form) }}
{% endblock %}", "program/new.html.twig", "/Users/pil/PhpstormProjects/wild-series/templates/program/new.html.twig");
    }
}
