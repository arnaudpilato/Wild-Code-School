...
class __TwigTemplate_313d8965dd76e01f5f3e2ffc370676a308bede857640f9eb1669421a270c7ecd extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <p>";
        // line 7
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("episodes.list"), "html", null, true);
        echo "</p>
        <ul>
            ";
        // line 9
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["episode"]) {
            // line 10
            echo "                <li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_episode_show", ["program_slug" => twig_get_attribute($this->env, $this->source, (isset($context["program"]) || array_key_exists("program", $context) ? $context["program"] : (function () { throw new RuntimeError('Variable "program" does not exist.', 10, $this->source); })()), "slug", [], "any", false, false, false, 10), "season" => twig_get_attribute($this->env, $this->source, (isset($context["season"]) || array_key_exists("season", $context) ? $context["season"] : (function () { throw new RuntimeError('Variable "season" does not exist.', 10, $this->source); })()), "id", [], "any", false, false, false, 10), "episode_slug" => twig_get_attribute($this->env, $this->source, $context["episode"], "slug", [], "any", false, false, false, 10)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["episode"], "title", [], "any", false, false, false, 10), "html", null, true);
            echo "</a></li>
            ";
        }
        ...
        <a href=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_show", ["slug" => twig_get_attribute($this->env, $this->source, (isset($context["program"]) || array_key_exists("program", $context) ? $context["program"] : (function () { throw new RuntimeError('Variable "program" does not exist.', 13, $this->source); })()), "slug", [], "any", false, false, false, 13)]), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("back.plug"), "html", null, true);
        echo "</a>
    </section>
";
    ...
    {
        return array (  104 => 13,  101 => 12,  90 => 10,  86 => 9,  81 => 7,  77 => 6,  71 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    <section>
        ...
        <p>{{ 'episodes.list'|trans }}</p>
        <ul>
            {% for episode in episodes %}
                <li><a href=\"{{ path(\"program_episode_show\", { program_slug: program.slug, season: season.id, episode_slug: episode.slug }) }}\">{{ episode.title }}</a></li>
            {% endfor %}
        </ul>
        <a href=\"{{ path(\"program_show\", { slug: program.slug }) }}\">{{ 'back.plug'|trans }}</a>
    </section>
