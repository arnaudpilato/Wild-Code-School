...
class __TwigTemplate_b20575b5bac92977f5e14622996bce46b9f31365f21758af37808af252802286 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("season.index"), "html", null, true);
    ...
    <table class=\"table\">
        ...
        if (!$context['_iterated']) {
            ...
            echo "            <tr>
                <td colspan=\"5\">";
            // line 32
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("no.record.found"), "html", null, true);
            echo "</td>
            </tr>
        ";
        }
...
";
    ...
    {
        return array (  176 => 38,  171 => 35,  162 => 32,  159 => 31,  148 => 27,  142 => 26,  137 => 24,  133 => 23,  129 => 22,  125 => 21,  122 => 20,  117 => 19,  110 => 15,  106 => 14,  102 => 13,  98 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}{{ 'season.index'|trans }}{% endblock %}

{% block body %}
    <h1>{{ 'season.index'|trans }}</h1>
    ...
    <table class=\"table\">
        ...
        {% for season in seasons %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('season_show', {'id': season.id}) }}\">{{ 'show'|trans }}</a>
                    <a href=\"{{ path('season_edit', {'id': season.id}) }}\">{{ 'edit'|trans }}</a>
                </td>
            </tr>
        {% else %}
            <tr>
    ...
    <a href=\"{{ path('season_new') }}\">{{ 'create.new'|trans }}</a>
{% endblock %}
", "season/index.html.twig", "/Users/pil/PhpstormProjects/wild-series/templates/season/index.html.twig");
    }
}
