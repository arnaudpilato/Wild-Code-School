...
/* index.html.twig */
class __TwigTemplate_0daa321e4cb06066767c31c85f042912d3ca1f9520d2b98d0ef4fa8b480b01f8 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("see.programs.plug"), "html", null, true);
        echo "</a>
    </section>
...
{% block body %}
    <section class=\"accueil\">
        <h1>Wild Series</h1>
        <a href=\"{{ path('program_index') }}\">{{ 'see.programs.plug'|trans }}</a>
    </section>
