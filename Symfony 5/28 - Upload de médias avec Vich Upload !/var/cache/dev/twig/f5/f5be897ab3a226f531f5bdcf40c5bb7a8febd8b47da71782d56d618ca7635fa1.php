...
class __TwigTemplate_506da73de4b3e67de92aaad162ee0bd7a1ec4dab367b46f2710f8129afc3a31c extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("new.episode"), "html", null, true);
...
{% block title %}{{ 'new.episode'|trans }}{% endblock %}

{% block body %}
    <h1>{{ 'new.episode'|trans }}</h1>

    {{ include('episode/_form.html.twig') }}

    <a href=\"{{ path('episode_index') }}\">{{ 'back.list'|trans }}</a>
{% endblock %}
", "episode/new.html.twig", "/Users/pil/PhpstormProjects/wild-series/templates/episode/new.html.twig");
    }
}
