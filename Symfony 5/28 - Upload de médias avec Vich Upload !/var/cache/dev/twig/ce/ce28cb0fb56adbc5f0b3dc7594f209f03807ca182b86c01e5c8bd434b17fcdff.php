...
class __TwigTemplate_94e03d0dd1339befbdf451a91d6f029e9d6c1f2d304b42362a36242fdf234c0d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["program"]) {
            ...
            // line 23
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/" . twig_get_attribute($this->env, $this->source, $context["program"], "poster", [], "any", false, false, false, 23))), "html", null, true);
            echo "\">
                        </div>
                        <div class=\"col-6\">
                            <h2>";
            ...
            <div class=\"row justify-content-around\">
                {% for program in programs %}
                    <div class=\"movie col-5 d-flex\">
                        <div class=\"poster col-6\">
                            <img class=\"poster\" src=\"{{ asset('uploads/' ~ program.poster) }}\">
                        </div>
                        <div class=\"col-6\">
                            <h2>{{ program.title }}</h2>
