...
class __TwigTemplate_b59582bfe9cb09b615d36ca8d7fe956165bf5d255c7b9feb145553adb5e07bcd extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["categories"]) || array_key_exists("categories", $context) ? $context["categories"] : (function () { throw new RuntimeError('Variable "categories" does not exist.', 5, $this->source); })()));
...
{% block body %}
    ...
    {% for category in categories %}
        <li><a href=\"{{ path(\"category_show\", { categoryName: category.name }) }}\">{{ category.name }}</a></li>
    {% endfor %}
    </ul>
{% endblock %}", "category/index.html.twig", "/Users/pil/PhpstormProjects/wild-series/templates/category/index.html.twig");
    }
}
