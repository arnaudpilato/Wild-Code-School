...
class __TwigTemplate_0ae82c79d70da5aed43351843dff757f32c2143e4b920b967380bdc4ef37a250 extends Template
{
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["episode"]) {
            // line 9
            echo "            <li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_episode_show", ["program" => twig_get_attribute($this->env, $this->source, (isset($context["program"]) || array_key_exists("program", $context) ? $context["program"] : (function () { throw new RuntimeError('Variable "program" does not exist.', 9, $this->source); })()), "id", [], "any", false, false, false, 9), "season" => twig_get_attribute($this->env, $this->source, (isset($context["season"]) || array_key_exists("season", $context) ? $context["season"] : (function () { throw new RuntimeError('Variable "season" does not exist.', 9, $this->source); })()), "number", [], "any", false, false, false, 9), "episode" => twig_get_attribute($this->env, $this->source, $context["episode"], "id", [], "any", false, false, false, 9)]), "html", null, true);
            echo "\">";
...
{% block body %}
    ...
    <ul>
        {% for episode in episodes %}
            <li><a href=\"{{ path(\"program_episode_show\", { program: program.id, season: season.number, episode: episode.id }) }}\">{{ episode.title }}</a></li>
        {% endfor %}
    </ul>
