...
return [
    ...
    'program_season_show' => [['program', 'season'], ['_controller' => 'App\\Controller\\ProgramController::showSeason'], [], [['variable', '/', '[^/]++', 'season', true], ['text', '/season'], ['variable', '/', '[^/]++', 'program', true], ['text', '/programs']], [], []],
